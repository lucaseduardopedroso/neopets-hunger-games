...
const standardEvents1 = [
    ...
    (player, pronouns) => `${player} encontra com Jhudora e não hesita em pedir uma selfie.`,
...
const standardEvents3 = [
    ...
    (player1, pronouns1, player2, pronouns2, player3, pronouns3) => `${player1} e ${player2} seguram ${player3} e ${pronouns3.object} expõe ao raio do laboratório secreto, mas nada acontece.`,
